...
class BaseOptions:
    ...
    def initialize(self, parser):
        ...
        parser.add_argument("--csv_path", default="placeholder")
        parser.add_argument(
            "--name",
            type=str,
        ...
        parser.add_argument(
            "--model", type=str, default="hist", choices=["hist"], help="model name"
        )
        parser.add_argument(
            "--input_nc", type=int, default=3, help="number of input image channels"
        )
        parser.add_argument(
            "--output_nc", type=int, default=3, help="number of output image channels"
        )
        parser.add_argument(
        ...
        parser.add_argument(
            "--patch_size", type=int, default=256, help="patch size for acrobat dataset"
        )
        parser.add_argument(
            "--max_dataset_size",
            type=int,
        ...
        parser.add_argument(
            "--verbose", action="store_true", help="print extra runtime information"
        )
        parser.add_argument(
            "--suffix",
            default="",
        ...
        parser.add_argument(
            "--run_id", default=None, type=str, help="manual run identifier"
        )
        parser.add_argument(
            "--misalign", default=0, type=int, help="maximum paired crop offset"
        )
        parser.add_argument(
            "--style_start", type=int, default=9, help="style injection start block"
        )

...
class TrainOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument(
            ...
            type=int,
            default=None,
            help="window id of the web display. Default is random window id",
        )
        parser.add_argument(
            "--display_server",
            type=str,
        ...
        parser.add_argument(
            "--evaluation_freq", type=int, default=1000, help="evaluation freq"
        )
        parser.add_argument(
            "--save_by_iter",
            action="store_true",
        ...
        parser.add_argument(
            ...
            type=str,
            default="",
            help='optional staged schedule. Use "default" or "load,crop,epochs,decay,batch;..."',
        )
        self.isTrain = True
        return parser
